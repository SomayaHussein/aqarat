...
class _AddPrpState extends State<AddPrp> {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('إضافة عقار جديد', style: TextStyle(color: Colors.white)),
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(color: Color(0xff997950)),
                    focusedBorder: OutlineInputBorder(
                      borderSide: BorderSide(color: Color(0xff0d843f)),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: _image == null
                        ? Center(child: Text('اختيار صورة', style: TextStyle(color: Colors.grey)))
                        : ClipRRect(
                      borderRadius: BorderRadius.circular(12),
                      child: Image.file(
                        _image!,
